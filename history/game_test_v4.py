...
def depth_to_audio(depth_image, threshold=4000):
    ...
    if right_median < threshold:
        ...
        right_sound = right_sound + right_volume
        right_sound = right_sound.pan(1)  # Pan fully to the right
        mixed_audio = mixed_audio.overlay(right_sound)
...
def update():
    ...
    if counter >= 2: # TODO: use threding here
