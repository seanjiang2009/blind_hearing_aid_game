...
sound_folder = "sound"
left_sound = AudioSegment.from_mp3(os.path.join(sound_folder, "left.wav"))
center_sound = AudioSegment.from_mp3(os.path.join(sound_folder, "center.wav"))
right_sound = AudioSegment.from_mp3(os.path.join(sound_folder, "right.wav"))

audio_refresh_rate = 0.5
...
def depth_to_audio(depth_image, threshold=4000):
    ...
    if center_mean < threshold:
        center_volume = depth_to_volume(center_mean, threshold)
        center_sound_out = center_sound + center_volume
        center_sound_out = center_sound_out.pan(0)  # Pan to the center
